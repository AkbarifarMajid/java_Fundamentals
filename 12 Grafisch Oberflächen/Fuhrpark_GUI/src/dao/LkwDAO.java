...
public class LkwDAO {
    ...
    public static boolean einfuegen_LKW(LKW lkw) {
        ...
        return DatabaseUtils.update_Mit_Parametern(sql_einfuegen, lkw.getId(), lkw.getLadevolumen());
    }// End einfuegen_LKW
    ...
    public static double getLadevolumen(int fahrzeugId) {
        ...
        try (ResultSet resultSet = DatabaseUtils.suche_Mit_Parametern(sql_Lade_Volumen, fahrzeugId)) {
    ...
    public static boolean bearbeiten_LKW(LKW lkw) {
        ...
        return DatabaseUtils.update_Mit_Parametern(sql_Bearbeiten, lkw.getLadevolumen(), lkw.getId());
    }// End bearbeiten_LKW
