...
public class MotorradDAO {
    ...
    public static boolean einfuegen(Motorrad motorrad) {
        ...
        return DatabaseUtils.executeUpdate(sql_einguegen, motorrad.getId(), motorrad.getHubraum(), motorrad.getGangschaltung());
    }//End einfuegen
    ...
    public static int getHubraum(int fahrzeugId) {
        ...
        try (ResultSet resultSet = DatabaseUtils.executePreparedSelect(sql_getHubraum, fahrzeugId)) {
    ...
    public static boolean getGangschaltung(int fahrzeugId) {
        ...
        try (ResultSet resultSet = DatabaseUtils.executePreparedSelect(sql_Gangschaltung, fahrzeugId)) {
    ...
    public static boolean bearbeiten(Motorrad motorrad) {
        ...
        return DatabaseUtils.executeUpdate(sql_Bearbeiten, motorrad.getHubraum(), motorrad.getGangschaltung(), motorrad.getId());
    }// End bearbeiten
