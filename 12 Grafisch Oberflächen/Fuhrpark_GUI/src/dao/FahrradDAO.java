...
public class FahrradDAO {
    ...
    public static boolean einfuegen(Fahrrad fahrrad) {
        ...
        return DatabaseUtils.executeUpdate(sql_einguegen, fahrrad.getId(), fahrrad.isHatKorb());
    }// End einfuegen
    ...
    public static boolean get_Korb(int fahrzeugId) {
        ...
        try (ResultSet resultSet = DatabaseUtils.executePreparedSelect(sql_hatKorb, fahrzeugId)) {
    ...
    public static boolean bearbeiten(Fahrrad fahrrad) {
        ...
        return DatabaseUtils.executeUpdate(sql_Berabeiten, fahrrad.isHatKorb(), fahrrad.getId());
    }// End bearbeiten
